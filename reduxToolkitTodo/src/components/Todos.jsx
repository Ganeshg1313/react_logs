        ...
        {todos.map((todo) => (
          ...
          >
           {editableId == todo.id ? (
            ...
            <button
            id="updateBtn"
            className="text-white bg-violet-500 border-0 py-1 px-4 focus:outline-none hover:bg-violet-700 rounded text-md"
